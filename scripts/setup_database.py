...
def init_database():
    ...
    # 2. RUN MIGRATIONS (Add missing columns to existing tables)
...
def seed_data(cursor, conn):
    ...
    # ... (Your existing seed_data logic goes here, or keep it minimal since create_mock_data handles the bulk) ...
    # For now, we will just ensure the Admin user exists so you can login.
